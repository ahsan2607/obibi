...
\begin{enumerate}[leftmargin=2em]
  \item \textbf{Modul Autentikasi Pengguna (FR-01):} Meliputi fitur pendaftaran akun baru serta fitur masuk sistem Login.
  \item \textbf{Modul Deteksi Interaksi Antarobat (FR-10):} Meliputi fungsionalitas mesin kecerdasan buatan berbasis *GraphRAG* dan *Agentic AI* dalam memproses input dua jenis obat atau lebih, mendeteksi kontraindikasi medis, serta menyajikan tingkat risiko secara akurat.
  \item \textbf{Modul Penjadwalan Konsumsi Obat (FR-03):} Meliputi fitur pengisian form nama obat, pengaturan batasan waktu harian (*input* jam), validasi format input, serta mekanisme pemicuan *reminder*/notifikasi aktif.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    ...
    Nama Pengujian      & Register Berhasil \\ \hline
    Requirement Terkait & FR-01 Autentikasi Pengguna \\ \hline
    Use Case            & Register \\ \hline
    Pre-condition       & \textit{User} belum memiliki akun Obibi dan koneksi internet tersedia \\ \hline
    Data Uji            & Nama: Najla, Email: najla@test.com, Password: password123 \\ \hline
    Langkah Pengujian   &
      1. Buka aplikasi Obibi \newline
      2. Klik tombol Register \newline
      3. Isi Nama, Email, dan Password \newline
      4. Klik tombol Register \\ \hline
    Expected Result     & Akun berhasil dibuat dan \textit{user} diarahkan ke halaman Login/Dashboard \\ \hline
    Post-condition      & Data akun tersimpan di \textit{database} \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    ...
    Nama Pengujian      & Register gagal karena koneksi \\ \hline
    ...
    Langkah Pengujian   &
      ...
      3. Isi Nama, Email, dan Password \newline
      4. Klik tombol Register \\ \hline
    Expected Result     & Sistem menampilkan pesan \textit{error} koneksi atau pendaftaran gagal \\ \hline
    Post-condition      & \textit{User} tetap berada di halaman register \\ \hline
    Status              & {[\checkmark]} Valid \quad [~~] Invalid \\ \hline
  \end{tabularx}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    ...
    Requirement Terkait & FR-10 Deteksi Interaksi Antarobat \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    ...
    Requirement Terkait & FR-10 \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    ...
    Requirement Terkait & FR-03 Penjadwalan Konsumsi Obat \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    ...
    Requirement Terkait & FR-03 \\ \hline
...
\begin{table}[H]
  ...
  \end{tabularx}
\end{table}
% ── 3.5 Use Case Kelola Data Obat ───────────────────────────────────────
\subsection{Pengujian Use Case Kelola Data Obat}

\subsubsection{DUPL-OBAT-01 --- Input Data Obat Berhasil}

\begin{table}[H]
  \caption{DUPL-OBAT-01: Input Data Obat Berhasil}
  \centering\small
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    \hline
    \textbf{Field} & \textbf{Isi} \\ \hline
    ID Pengujian        & DUPL-OBAT-01 \\ \hline
    Nama Pengujian      & Input data obat berhasil \\ \hline
    Requirement Terkait & FR-02 Manajemen Data Obat \\ \hline
    Use Case            & Kelola data obat \\ \hline
    Pre-condition       & \textit{User} sudah login \\ \hline
    Data Uji            & Nama obat: Paracetamol, Deskripsi: Demam dan sakit kepala, Dosis: 1 tablet, Efek Samping: Mengantuk, Stok: 20 \\ \hline
    Langkah Pengujian   &
      1. Buka halaman Kelola Obat \newline
      2. Klik tombol Tambah Obat \newline
      3. Isi form dengan data uji valid \newline
      4. Klik Simpan Obat \\ \hline
    Expected Result     & Data obat tersimpan dan muncul di daftar obat \\ \hline
    Post-condition      & Data obat tersimpan di \textit{database} \\ \hline
    Status              & {[\checkmark]} Valid \quad [~~] Invalid \\ \hline
  \end{tabularx}
\end{table}

\subsubsection{DUPL-OBAT-02 --- Validasi Nama Obat Kosong}

\begin{table}[H]
  \caption{DUPL-OBAT-02: Validasi Nama Obat Kosong}
  \centering\small
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    \hline
    \textbf{Field} & \textbf{Isi} \\ \hline
    ID Pengujian        & DUPL-OBAT-02 \\ \hline
    Nama Pengujian      & Validasi nama obat kosong \\ \hline
    Requirement Terkait & FR-02 Manajemen Data Obat \\ \hline
    Pre-condition       & Modal tambah obat terbuka \\ \hline
    Data Uji            & Nama obat: kosong, Deskripsi: Demam dan sakit kepala \\ \hline
    Langkah Pengujian   &
      1. Biarkan field nama obat kosong \newline
      2. Klik Simpan Obat \\ \hline
    Expected Result     & Sistem mencegah pengiriman form dan meminta field nama diisi \\ \hline
    Post-condition      & Data obat tidak tersimpan \\ \hline
    Status              & {[\checkmark]} Valid \quad [~~] Invalid \\ \hline
  \end{tabularx}
\end{table}

\subsubsection{DUPL-OBAT-03 --- Hapus Data Obat Berhasil}

\begin{table}[H]
  \caption{DUPL-OBAT-03: Hapus Data Obat Berhasil}
  \centering\small
  \begin{tabularx}{\textwidth}{|p{4.5cm}|X|}
    \hline
    \textbf{Field} & \textbf{Isi} \\ \hline
    ID Pengujian        & DUPL-OBAT-03 \\ \hline
    Nama Pengujian      & Hapus data obat berhasil \\ \hline
    Requirement Terkait & FR-02 Manajemen Data Obat \\ \hline
    Pre-condition       & Terdapat minimal satu obat di dalam daftar obat \\ \hline
    Data Uji            & Obat yang sudah tersimpan \\ \hline
    Langkah Pengujian   &
      1. Buka halaman Kelola Obat \newline
      2. Klik tombol Hapus pada salah satu obat \newline
      3. Konfirmasi penghapusan pada dialog pop-up \\ \hline
    Expected Result     & Obat terhapus dari daftar dan database secara permanen \\ \hline
    Post-condition      & Data dihapus secara cascade (termasuk semua jadwal terkait) dari \textit{database} \\ \hline
    Status              & {[\checkmark]} Valid \quad [~~] Invalid \\ \hline
  \end{tabularx}
\end{table}

% ── 3.6 Summary Pengujian ────────────────────────────────────────────
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{2cm}|X|X|}
    ...
    FR-01 & Autentikasi Pengguna            & DUPL-LOGIN-01, DUPL-LOGIN-02, DUPL-REGISTER-01, DUPL-REGISTER-02 \\ \hline
    FR-02 & Manajemen Data Obat             & DUPL-OBAT-01 s.d. 03 \\ \hline
    FR-03 & Penjadwalan Konsumsi Obat       & DUPL-JADWAL-01 s.d. 03 \\ \hline
    FR-10 & Deteksi Interaksi Antarobat     & DUPL-INTERAKSI-01 s.d. 03 \\ \hline
  \end{tabularx}
\end{table}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{kelola_obat.png}
  \caption{Screenshot Pelaksanaan Uji DUPL-OBAT-01 (Kelola Data Obat)}
  \label{fig:screenshot_kelola_obat}
\end{figure}
